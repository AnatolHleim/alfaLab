...
class ScreenReservedAccount {
    ...
    getTextButtonTryAnotherUNP() {
        return __awaiter(this, void 0, void 0, function* () {
            yield protractor_1.browser.wait(protractor_1.ExpectedConditions.visibilityOf(this.buttonTryAnotherUNP), 5000, 'Waiting for buttonTryAnotherUNP');
            return yield HelperMethods_1.HelperMethods.getText(this.buttonTryAnotherUNP);
        });
    }
    clickButtonTryAnotherUNP() {
        return __awaiter(this, void 0, void 0, function* () {
            yield protractor_1.browser.wait(protractor_1.ExpectedConditions.visibilityOf(this.buttonTryAnotherUNP), 5000, 'Waiting for buttonTryAnotherUNP');
            yield this.buttonTryAnotherUNP.click();
        });
    }
    clickLogo() {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.ScreenReservedAccount = ScreenReservedAccount;
